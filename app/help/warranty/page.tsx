  ...
  return (
    <div className="prose prose-blue max-w-none">
      ...
      <section className="mb-10 text-brand-700 bg-brand-50 p-6 rounded-xl border border-brand-100">
        ...
        <p>
          To initiate a warranty claim, please contact us via WhatsApp at <strong>0735152402</strong> or email <strong>warranty@advocatesiphones.co.za</strong> with your order number and a description of the issue.
        </p>
      </section>
    </div>
  );
